...
func (csp *impl) KeyGen(opts bccsp.KeyGenOpts) (k bccsp.Key, err error) {
	// Validate arguments
	if opts == nil {
		return nil, errors.Errorf("Invalid Opts parameter. It must not be nil.")
	}
	...
	if !opts.Ephemeral() {
		...
		if err != nil {
			return nil, errors.Errorf("Failed storing key [%s]. [%s]", opts.Algorithm(), err)
		}
	}
...
func (csp *impl) KeyDeriv(k bccsp.Key, opts bccsp.KeyDerivOpts) (dk bccsp.Key, err error) {
	// Validate arguments
	if k == nil {
		return nil, errors.Errorf("Invalid Key. It must not be nil.")
	}
	if opts == nil {
		return nil, errors.Errorf("Invalid opts. It must not be nil.")
	}
...
func (csp *impl) KeyImport(raw interface{}, opts bccsp.KeyImportOpts) (k bccsp.Key, err error) {
	// Validate arguments
	if raw == nil {
		return nil, errors.Errorf("Invalid raw. It must not be nil.")
	}
	if opts == nil {
		return nil, errors.Errorf("Invalid opts. It must not be nil.")
	}
...
func (csp *impl) Sign(k bccsp.Key, digest []byte, opts bccsp.SignerOpts) (signature []byte, err error) {
	...
	if len(digest) == 0 {
		return nil, errors.Errorf("Invalid digest. Cannot be empty.")
	}
...
func (csp *impl) Verify(k bccsp.Key, signature, digest []byte, opts bccsp.SignerOpts) (valid bool, err error) {
	// Validate arguments
	if k == nil {
		return false, errors.Errorf("Invalid Key. It must not be nil.")
	}
	if len(signature) == 0 {
		return false, errors.Errorf("Invalid signature. Cannot be empty.")
	}
	if len(digest) == 0 {
		return false, errors.Errorf("Invalid digest. Cannot be empty.")
	}
