...
import (
	...
	"github.com/oktfolio/hyperledger-fabric-gm/common/diag"
...
func TestCaptureGoRoutines(t *testing.T) {
	...
	gt.Expect(output).To(ContainSubstring("github.com/oktfolio/hyperledger-fabric-gm/common/diag.CaptureGoRoutines"))
}
