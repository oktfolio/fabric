...
import (
	...
	"github.com/oktfolio/hyperledger-fabric-gm/integration/nwo/commands"
	"github.com/oktfolio/hyperledger-fabric-gm/integration/nwo/fabricconfig"
...
var _ = Describe("EndToEnd", func() {
	...
	BeforeEach(func() {
		...
		chaincode = nwo.Chaincode{
			Name:    "mycc",
			Version: "0.0",
			Path:    "github.com/oktfolio/hyperledger-fabric-gm/integration/chaincode/simple/cmd",
...
func compilePlugin(pluginType string) string {
	...
	cmd := exec.Command(
		...
		"-o", pluginFilePath,
		fmt.Sprintf("github.com/oktfolio/hyperledger-fabric-gm/integration/pluggable/testdata/plugins/%s", pluginType),
	)
