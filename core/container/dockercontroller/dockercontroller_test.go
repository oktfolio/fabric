...
import (
	...
	coreutil "github.com/oktfolio/hyperledger-fabric-gm/core/testutil"
...
func Test_Start(t *testing.T) {
	...
	chaincodePath := "github.com/oktfolio/hyperledger-fabric-gm/examples/chaincode/go/example01/cmd"
