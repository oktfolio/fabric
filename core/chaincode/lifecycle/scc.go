...
// Path returns "github.com/oktfolio/hyperledger-fabric-gm/core/chaincode/lifecycle"
func (scc *SCC) Path() string {
	return "github.com/oktfolio/hyperledger-fabric-gm/core/chaincode/lifecycle"
}
