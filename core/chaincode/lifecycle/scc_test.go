...
import (
	...
	"github.com/oktfolio/hyperledger-fabric-gm/core/chaincode/lifecycle/mock"
	"github.com/oktfolio/hyperledger-fabric-gm/core/chaincode/shim"
	lb "github.com/oktfolio/hyperledger-fabric-gm/protos/peer/lifecycle"
...
var _ = Describe("SCC", func() {
	...
	Describe("Path", func() {
		It("returns the path", func() {
			Expect(scc.Path()).To(Equal("github.com/oktfolio/hyperledger-fabric-gm/core/chaincode/lifecycle"))
		})
	})
