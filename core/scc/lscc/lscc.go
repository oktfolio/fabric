...
import (
	...
	"github.com/oktfolio/hyperledger-fabric-gm/core/policyprovider"
...
func (lscc *LifeCycleSysCC) Path() string              { return "github.com/oktfolio/hyperledger-fabric-gm/core/scc/lscc" }
